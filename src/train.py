...
try:
    model.export(SAVEMODEL_VERSIONED)
    print(f"Model exported successfully in TensorFlow SavedModel format at {SAVEMODEL_VERSIONED}")
except Exception as e:
    print(f"Error exporting model in SavedModel format: {e}")
